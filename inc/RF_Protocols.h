...
/*
 * Hunter Fan Protocol A
 */
#if EFM8BB1_SUPPORT_HUNTER_PROTOCOL == 1
#define HUNTER
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(HUNTER)[], static uint16_t, SI_SEG_CODE) = {500, 310, 5060, 830, 25900};
SI_SEGMENT_VARIABLE(PROTOCOL_START(HUNTER)[], static uint8_t, SI_SEG_CODE) = { LOW(4), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(0), HIGH(0), LOW(1), HIGH(0), LOW(2) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(HUNTER)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(0) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(HUNTER)[], static uint8_t, SI_SEG_CODE) = { HIGH(3), LOW(0) };
#endif

/*
 * Hunter Fan Protocol B
 */
#if EFM8BB1_SUPPORT_HUNTER_B_PROTOCOL == 1
#define HUNTER_B
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(HUNTER_B)[], static uint16_t, SI_SEG_CODE) = { 392, 5096, 784, 20776 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(HUNTER_B)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(1) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(HUNTER_B)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(2) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(HUNTER_B)[], static uint8_t, SI_SEG_CODE) = { HIGH(2), LOW(0) };
SI_SEGMENT_VARIABLE(PROTOCOL_END(HUNTER_B)[], static uint8_t, SI_SEG_CODE) = { LOW(3) };
#endif

/*
 * Hunter Fan Protocol C
 */
#if EFM8BB1_SUPPORT_HUNTER_C_PROTOCOL == 1
#define HUNTER_C
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(HUNTER_C)[], static uint16_t, SI_SEG_CODE) = { 400, 5096, 840 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(HUNTER_C)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(1) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(HUNTER_C)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(0) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(HUNTER_C)[], static uint8_t, SI_SEG_CODE) = { HIGH(2), LOW(0) };
#endif

/*
 * Hunter Fan Protocol D
 */
#if EFM8BB1_SUPPORT_HUNTER_D_PROTOCOL == 1
#define HUNTER_D
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(HUNTER_D)[], static uint16_t, SI_SEG_CODE) = { 0x01E0, 0x014A, 0x13CE, 0x0386, 0x4FF2  };
SI_SEGMENT_VARIABLE(PROTOCOL_START(HUNTER_D)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(1), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(1), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(2)};
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(HUNTER_D)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(3) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(HUNTER_D)[], static uint8_t, SI_SEG_CODE) = { HIGH(3), LOW(0) };
SI_SEGMENT_VARIABLE(PROTOCOL_END(HUNTER_D)[], static uint8_t, SI_SEG_CODE) = { LOW(4) };
#endif

/*
 * Hunter Fan Protocol E
 */
#if EFM8BB1_SUPPORT_HUNTER_E_PROTOCOL == 1
#define HUNTER_E
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(HUNTER_E)[], static uint16_t, SI_SEG_CODE) = { 0x01E0, 0x13CE, 0x0386  };
SI_SEGMENT_VARIABLE(PROTOCOL_START(HUNTER_E)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(1)};
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(HUNTER_E)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(2) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(HUNTER_E)[], static uint8_t, SI_SEG_CODE) = { HIGH(2), LOW(0) };
#endif
...
SI_SEGMENT_VARIABLE(PROTOCOL_DATA[], static struct BUCKET_PROTOCOL_DATA, SI_SEG_CODE) =
{
		 ...
		 */
		{
			{ &PROTOCOL_BUCKETS(HUNTER), ARRAY_LENGTH(PROTOCOL_BUCKETS(HUNTER)) },
			{ &PROTOCOL_START(HUNTER), ARRAY_LENGTH(PROTOCOL_START(HUNTER)) },
			{ &PROTOCOL_BIT0(HUNTER), ARRAY_LENGTH(PROTOCOL_BIT0(HUNTER)) },
			{ &PROTOCOL_BIT1(HUNTER), ARRAY_LENGTH(PROTOCOL_BIT1(HUNTER)) },
			{ NULL, 0 },
			66
		},
#endif
#if EFM8BB1_SUPPORT_HUNTER_B_PROTOCOL == 1
		/*
		 * Hunter B Fan Protocol
		 */
		{
			{ &PROTOCOL_BUCKETS(HUNTER_B), ARRAY_LENGTH(PROTOCOL_BUCKETS(HUNTER_B)) },
			{ &PROTOCOL_START(HUNTER_B), ARRAY_LENGTH(PROTOCOL_START(HUNTER_B)) },
			{ &PROTOCOL_BIT0(HUNTER_B), ARRAY_LENGTH(PROTOCOL_BIT0(HUNTER_B)) },
			{ &PROTOCOL_BIT1(HUNTER_B), ARRAY_LENGTH(PROTOCOL_BIT1(HUNTER_B)) },
			{ &PROTOCOL_END(HUNTER_B), ARRAY_LENGTH(PROTOCOL_END(HUNTER_B))  },
			66
		},
#endif
#if EFM8BB1_SUPPORT_HUNTER_C_PROTOCOL == 1
		/*
		 * Hunter C Fan Protocol
		 */
		{
			{ &PROTOCOL_BUCKETS(HUNTER_C), ARRAY_LENGTH(PROTOCOL_BUCKETS(HUNTER_C)) },
			{ &PROTOCOL_START(HUNTER_C), ARRAY_LENGTH(PROTOCOL_START(HUNTER_C)) },
			{ &PROTOCOL_BIT0(HUNTER_C), ARRAY_LENGTH(PROTOCOL_BIT0(HUNTER_C)) },
			{ &PROTOCOL_BIT1(HUNTER_C), ARRAY_LENGTH(PROTOCOL_BIT1(HUNTER_C)) },
			{ NULL, 0 },
			66
		},
#endif
		 ...
		 */
		{
			{ &PROTOCOL_BUCKETS(HUNTER_D), ARRAY_LENGTH(PROTOCOL_BUCKETS(HUNTER_D)) },
			{ &PROTOCOL_START(HUNTER_D), ARRAY_LENGTH(PROTOCOL_START(HUNTER_D)) },
			{ &PROTOCOL_BIT0(HUNTER_D), ARRAY_LENGTH(PROTOCOL_BIT0(HUNTER_D)) },
			{ &PROTOCOL_BIT1(HUNTER_D), ARRAY_LENGTH(PROTOCOL_BIT1(HUNTER_D)) },
			{ &PROTOCOL_END(HUNTER_D), ARRAY_LENGTH(PROTOCOL_END(HUNTER_D))  },
			66
		},
#endif
#if EFM8BB1_SUPPORT_HUNTER_E_PROTOCOL == 1
		 ...
		 */
		{
			{ &PROTOCOL_BUCKETS(HUNTER_E), ARRAY_LENGTH(PROTOCOL_BUCKETS(HUNTER_E)) },
			{ &PROTOCOL_START(HUNTER_E), ARRAY_LENGTH(PROTOCOL_START(HUNTER_E)) },
			{ &PROTOCOL_BIT0(HUNTER_E), ARRAY_LENGTH(PROTOCOL_BIT0(HUNTER_E)) },
			{ &PROTOCOL_BIT1(HUNTER_E), ARRAY_LENGTH(PROTOCOL_BIT1(HUNTER_E)) },
			{ NULL, 0 },
			66
		},
#endif
