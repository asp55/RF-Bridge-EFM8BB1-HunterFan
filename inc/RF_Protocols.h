...
#define HUNTER
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(HUNTER)[], static uint16_t, SI_SEG_CODE) = { 0x01E0, 0x13CE, 0x0386  };
SI_SEGMENT_VARIABLE(PROTOCOL_START(HUNTER)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(1)};
