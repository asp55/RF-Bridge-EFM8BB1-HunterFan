...
#define HUNTER
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(HUNTER)[], static uint16_t, SI_SEG_CODE) = { 392, 5096, 784, 20776 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(HUNTER)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(0), HIGH(0), LOW(1) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(HUNTER)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(2) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(HUNTER)[], static uint8_t, SI_SEG_CODE) = { HIGH(2), LOW(0) };
SI_SEGMENT_VARIABLE(PROTOCOL_END(HUNTER)[], static uint8_t, SI_SEG_CODE) = { LOW(3) };
#endif
...
SI_SEGMENT_VARIABLE(PROTOCOL_DATA[], static struct BUCKET_PROTOCOL_DATA, SI_SEG_CODE) =
{
		 ...
		 */
		{
			...
			{ &PROTOCOL_END(HUNTER), ARRAY_LENGTH(PROTOCOL_END(HUNTER))  },
			66
		},
#endif
};
